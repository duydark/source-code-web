		...
		<div class="row">	
			...
			if($capnhap=='capnhap'){
				...
				<form action="" method="POST">
					<input type="text" class="form-control" name="danhmuc" value="<?php echo $row_capnhap['ten_danhmuc']?>"></br>
					<input type="hidden" class="form-control" name="id_danhmuc" value="<?php echo $row_capnhap['id_danhmuc']?>"></br>
			...
			<div class="col-md-8">
				...
				<?php 
				$sql_select_danhmuc=mysqli_query($khangduy,"SELECT * FROM danhmuc ORDER BY id_danhmuc DESC");
				?>
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="?xoa=<?php echo $row_danhmuc['id_danhmuc']?>"> Xóa </a> || <a href="?quanly=capnhap&id=<?php echo $row_danhmuc['id_danhmuc']?>">Cập nhập</a> </td>
					</tr>	
					<?php
					}
					?>
