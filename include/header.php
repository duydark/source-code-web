  ...
  if(isset($_POST['dangnhap_home'])){
    ...
    if($taikhoan==''|| $matkhau==''){
      echo '<script>alert("Xin nhập đầy đủ thông tin")</script>';
        ...
        $sql_select_admin=mysqli_query($khangduy,"SELECT * FROM khachhang where email='$taikhoan' AND password='$matkhau' LIMIT 1");
        $count=mysqli_num_rows($sql_select_admin);
        $row_dangnhap=mysqli_fetch_array($sql_select_admin);
        if($count>0){
          $_SESSION['dangnhap_home']=$row_dangnhap['name'];
           $_SESSION['id_khachhang']=$row_dangnhap['id_khachhang'];       
           header('location: index.php?quanly=giohang');
        }else{
             echo '<script>alert("Tài khỏan hoặc mật khẩu sai")</script>';
        }
    }
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="index.php?quanly=xemdonhang&id_khach=<?php $_SESSION['id_khachhang']?>" class="text-white">
						...
						?>
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> 0943 14 45 14
						</li>
						<li class="text-center border-right text-white">
				...
				<div class="modal-body">
					<form action="#" method="post">
						...
						<p class="text-center dont-do mt-3">Chưa có tài khoản?
							<a href="#" data-toggle="modal" data-target="#dangky">Đăng ký ngay</a>
						</p>
					</form>
				</div>
			</div>
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold font-italic">
							<img src="images/logo2.jpg" alt=" " class="img-fluid" style="width: 60px;height: 80px">				Khang Duy
						</a>
					</h1>
				</div>
				<!-- //logo -->
