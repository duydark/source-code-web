...
<?php 
	if(isset($_POST['search_button'])){
		$tukhoa=addslashes($_POST['search_product']);
			$sql_timkiem_product=mysqli_query($khangduy,"SELECT * FROM sanpham WHERE ten_sanpham LIKE '%$tukhoa%' ORDER BY id_sanpham DESC");
						$tieude=$tukhoa;
			}
?>
...
<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Từ khóa tìm kiếm: <?php echo $tieude ?></h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
								<?php
									...
									while($row_sanpham=mysqli_fetch_array($sql_timkiem_product)){
								?>
				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						...
						<div class="left-side border-bottom py-2">
							...
							<ul>
								<li>
									<input type="checkbox" class="checked">x1
